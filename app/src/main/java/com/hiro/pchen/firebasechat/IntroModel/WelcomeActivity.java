 ...
 * This java activity was adapted from a post from Ravi Tamada on 10/5/2016
 * But has some modifications by myself
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.intro_slide_01,
                R.layout.intro_slide_02,
                R.layout.intro_slide_03,};
